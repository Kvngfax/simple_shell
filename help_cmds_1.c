...
void void display_exit_help(void);
void display_help_cmd(void);

/**
 * display_all_help - Show information for all builtin commands.
 */
void display_all_help(void)
{
...
/**
 * display_cd_help - Show details on the 'cd' builtin
 * 			Show details on the 'cd' builtin command.
 */
void display_cd_help(void)
{
...
/**
 * void display_exit_help - Displays information on the shellby builtin command 'exit'.
 */
void void display_exit_help(void)
{
...
/**
 * display_help_cmd - Displays information on the shellby builtin command 'help'.
 */
void display_help_cmd(void)
{
